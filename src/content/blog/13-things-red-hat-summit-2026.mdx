...
**The fix**: Build custom execution environments with `ansible-builder`. Start with the supported base images and layer in your collections and dependencies. Test execution environments in a dev AAP instance before promoting to production. Check out my [Ansible content](/blog/tags/ansible/) for detailed guides.
