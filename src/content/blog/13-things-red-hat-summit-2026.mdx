...
snippet: "Real conversations from the Red Hat Summit 2026 floor in Atlanta — the pain points, gaps, and needs enterprises actually have with OpenShift, Kubernetes."
description: "Real conversations from the Red Hat Summit 2026 floor in Atlanta — the pain points, gaps, and needs enterprises actually have with OpenShift, Kubernetes, and."
image:
...
**The fix**: Build custom execution environments with `ansible-builder`. Start with the supported base images and layer in your collections and dependencies. Test execution environments in a dev AAP instance before promoting to production. Check out my [Ansible tutorial](/blog/ansible-tutorial-beginners-guide-2026/) for detailed guides.
