...
snippet: "Deep dive into OpenClaw gateway bind modes (loopback, lan, tailnet, auto, custom), Control UI origin enforcement, and the allowedOrigins vs dangerouslyAllowHostHeaderOriginFallback trade-off."
...
tags:
  ...
  - docker
image:
  src: "https://placehold.co/600x400?text=OpenClaw+Gateway+Config"
...
## 🛡️ Recommended Configuration for Azure
