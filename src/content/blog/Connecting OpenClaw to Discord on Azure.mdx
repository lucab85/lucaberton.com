---
draft: false
title: "Connecting OpenClaw to Discord on Azure: Bot Setup and Configuration"
snippet: "Complete guide to creating a Discord bot, configuring intents, generating an invite link, and connecting it to your OpenClaw instance running on Azure. Includes fixing the Fatal Gateway error 4014."
...
tags:
  ...
  - tutorial
image:
  src: "https://placehold.co/600x400?text=OpenClaw+Discord+Bot"
