---
draft: false
title: "Fix Ansible Service Module Not Starting"
seoTitle: "Fix Ansible Service Module Not Starting"
snippet: "Service module reports success but service isn't running? Check systemd unit files, ExecStart paths, and service dependencies."
description: "Service module reports success but service isn't running? Check systemd unit files, ExecStart paths, and service dependencies."
...
image:
  ...
  alt: "Fix Ansible Service Module Not Starting"
---
...
```
service module not starting service
```
