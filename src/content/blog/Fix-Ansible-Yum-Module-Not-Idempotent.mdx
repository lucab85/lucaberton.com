---
draft: false
title: "Fix Ansible Yum Module Not Idempotent"
seoTitle: "Fix Ansible Yum Module Not Idempotent"
snippet: "Yum module reporting changed every run? Fix package name wildcards, version pinning, and state parameter for true idempotency."
description: "Yum module reporting changed every run? Fix package name wildcards, version pinning, and state parameter for true idempotency."
...
image:
  ...
  alt: "Fix Ansible Yum Module Not Idempotent"
---
