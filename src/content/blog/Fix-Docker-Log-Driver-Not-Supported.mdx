---
draft: false
title: "Fix Docker Log Driver Not Supported"
seoTitle: "Fix Docker Log Driver Not Supported"
snippet: "Logging configuration failing? Compare log drivers — json-file, syslog, fluentd — and configure driver-specific options."
description: "Logging configuration failing? Compare log drivers — json-file, syslog, fluentd — and configure driver-specific options."
...
image:
  ...
  alt: "Fix Docker Log Driver Not Supported"
---
