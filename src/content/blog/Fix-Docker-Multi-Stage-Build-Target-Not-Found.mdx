...
snippet: "Named stage not found in multi-stage build? Fix AS names, --target flags, and stage references in COPY --from with step-by-step commands and examples."
