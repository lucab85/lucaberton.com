---
draft: false
title: "Fix Docker Windows Container on Linux Error"
seoTitle: "Fix Docker Windows Container on Linux Error"
snippet: "Wrong container platform? Switch between Windows and Linux containers, understand platform limitations, and use multi-platform images."
description: "Wrong container platform? Switch between Windows and Linux containers, understand platform limitations, and use multi-platform images."
...
image:
  ...
  alt: "Fix Docker Windows Container on Linux Error"
---
...
```
windows container linux mismatch
```
