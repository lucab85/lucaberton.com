...
description: "Last-applied annotation exceeding limits? Enable server-side apply, reduce manifest size, or configure annotation compression."
...
Helm operation fails with `Annotation Too Long Error`.
