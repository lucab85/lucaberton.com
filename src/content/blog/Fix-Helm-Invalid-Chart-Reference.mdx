...
snippet: "Chart reference format wrong? Understand repo/chart, URL, OCI, and local path reference formats. Practical guide with examples, commands, and best practices."
description: "Chart reference format wrong? Understand repo/chart, URL, OCI, and local path reference formats. Practical guide with examples and production-ready."
...
Helm operation fails with `Invalid Chart Reference`.
