...
description: "Helm template rendering producing invalid YAML? Debug template functions, whitespace control, and complex value rendering."
...
Helm operation fails with `YAML Parse Error in Templates`.
