---
draft: false
title: "Fix Kubernetes OOMKilled"
seoTitle: "Fix Kubernetes OOMKilled"
snippet: "Pod terminated with OOMKilled (exit code 137)? Learn how to diagnose memory limits, set proper resource requests, and prevent out-of-memory kills."
description: "Pod terminated with OOMKilled (exit code 137)? Learn how to diagnose memory limits, set proper resource requests, and prevent out-of-memory kills."
