---
draft: false
title: "Fix Terraform Backend Configuration Changed"
seoTitle: "Fix Terraform Backend Configuration Changed"
snippet: "Backend config changed and requires reinitialization? Safely migrate state between backends with terraform init -migrate-state."
description: "Backend config changed and requires reinitialization? Safely migrate state between backends with terraform init -migrate-state."
...
image:
  ...
  alt: "Fix Terraform Backend Configuration Changed"
---
