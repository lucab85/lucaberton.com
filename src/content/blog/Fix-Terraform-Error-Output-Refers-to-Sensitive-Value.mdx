---
draft: false
title: "Fix Terraform Error Output Refers to Sensitive Value"
seoTitle: "Fix Terraform Error Output Refers to Sensitive Value"
snippet: "Output contains sensitive value? Mark outputs as sensitive, use nonsensitive() function, and handle sensitive data in modules."
description: "Output contains sensitive value? Mark outputs as sensitive, use nonsensitive() function, and handle sensitive data in modules."
...
image:
  ...
  alt: "Fix Terraform Error Output Refers to Sensitive Value"
---
