...
snippet: "State locked by another process? Diagnose stuck locks, force-unlock safely, and configure lock timeout settings. Practical guide with examples, commands, and."
