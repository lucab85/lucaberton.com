...
snippet: "Diagnose and fix the 'unauthorized: gateway token mismatch' WebSocket error in OpenClaw. Learn how gateway auth tokens work, why token_mismatch happens after restarts, and how to restore connectivity between CLI tools and the running gateway."
