---
draft: false
title: "Installing OpenClaw on Azure with Docker: Complete Walkthrough"
snippet: "A hands-on guide to cloning, building, and running OpenClaw on an Azure VM using Docker Compose. Covers the docker-setup.sh wizard, the onboarding flow, and getting the gateway container running."
...
tags:
  ...
  - tutorial
image:
  src: "https://placehold.co/600x400?text=Installing+OpenClaw+Docker"
...
Your OpenClaw container is running! Next, we'll configure the gateway bind and Control UI settings: [Configuring OpenClaw Gateway Bind and Control UI](/blog/configuring-openclaw-gateway-bind-and-control-ui).
