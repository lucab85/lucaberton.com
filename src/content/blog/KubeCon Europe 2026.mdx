...
snippet: "Luca Berton presents 'Lessons Learned Orchestrating Multi-Tenant GPUs on OpenShift AI with NVIDIA KAI (G/H200)' at KubeCon + CloudNativeCon Europe 2026 in London — the world's largest Kubernetes conference."
