...
snippet: "Build production-ready monitoring for RHEL AI models using Prometheus, Grafana, GPU thermals, cgroup pressure, and MMLU drift detection, based on Practical RHEL AI Chapter 6."
...
│                    RHEL AI Models                           │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐      │
│  │  vLLM Serve  │  │ Fine-tuned   │  │  Inference   │      │
│  │              │  │  Granite     │  │  Pipeline    │      │
│  └──────────────┘  └──────────────┘  └──────────────┘      │
└─────────────────────┬──────────────────────────────────────┘
...
┌─────────────────────▼──────────────────────────────────────┐
│              Prometheus Server                              │
│  • GPU metrics (vram, utilization, temp)                   │
│  • Model metrics (latency, throughput, accuracy)           │
│  • Application metrics (errors, cache hits)                │
