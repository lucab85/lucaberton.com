...
snippet: "Fix the infamous Nexus 5X and 6P bootloop issue (BLOD) by disabling faulty A57 cores and running only on A53 cores using a custom recovery and workaround."
