---
draft: false
title: "OpenClaw Config Migration: channels.discord and Schema Changes"
snippet: "How OpenClaw handles config schema migrations, the move from discord to channels.discord, validation errors on old paths, and best practices for managing OpenClaw configuration changes across versions."
