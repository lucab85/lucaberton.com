...
snippet: "OpenClaw's Gmail Watcher runs silently alongside your gateway. Learn how the email channel integration works, how it starts and stops with the gateway lifecycle, and how to configure email-based agent interactions on Azure."
