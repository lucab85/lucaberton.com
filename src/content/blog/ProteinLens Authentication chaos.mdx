---
draft: false
title: "Authentication chaos: Microsoft Entra External ID nearly derailed my MVP"
snippet: "I tried implementing Microsoft Entra External ID expecting an easy B2C setup with a future path to B2B and SSO. Instead I hit portal-driven complexity, confusing mental models, and a sign-in redirect that felt like a different product. Here’s what went wrong, what Azure AD B2C’s new-customer cutoff means, and the simpler approach I’m using for social auth + Stripe subscriptions."
...
---
# Authentication chaos: my failed attempt at Microsoft Entra External ID (and what I’m doing instead)
