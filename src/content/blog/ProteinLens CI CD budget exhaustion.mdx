...
snippet: "ProteinLens CI/CD didn’t fail with a red build — it didn’t start at all. GitHub Actions stopped the pipeline with: “The job was not started because an Actions budget is preventing further use.” A small incident that exposed a bigger truth: quotas are part of architecture. Here’s what happened, what I changed (org repo + Azure subscription billing + tighter pipelines), and the checklist I ship with now."
...
---
Here’s a “lessons learned” write-up you can drop straight into a post-mortem / blog post, anchored on the exact GitHub Actions error and your actual fix (move to org + connect Azure subscription + Copilot Business).

---

## Lessons learned from exhausting the GitHub Actions CI/CD budget
