...
description: "AI model weight distribution on Kubernetes. OCI registries, P2P distribution with Dragonfly, Harbor model management. Covers diagnosis with kubectl, root."
image:
