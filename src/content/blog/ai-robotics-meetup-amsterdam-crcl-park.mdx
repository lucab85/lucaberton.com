...
description: "Attending the largest AI on the Amstel meetup on AI in robotics. Panelists from Monumental, Picnic, and TU Delft on moving from demos to scalable systems."
...
- **Simulation compute** — training in virtual environments requires [GPU clusters](/blog/nvidia-gpu-operator-kubernetes-setup/) at scale
