...
description: "Build Kubernetes Operators with Ansible for Day-2 operations. Automate backup, scaling, upgrades, and disaster recovery with the Operator SDK."
...
- [Automate Kubernetes Day-2 Operations with Ansible](https://kubernetes.recipes/recipes/deployments/ansible-kubernetes-day2-automation/) — the copy-paste recipe on Kubernetes Recipes
