---
title: "Ansible VS Code Extension with MCP Server"
snippet: "Red Hat's Ansible VS Code extension now embeds an MCP server for AI-assisted playbook creation, context-aware linting, and compliant scaffolding."
...
At **Red Hat Tech Day Netherlands** (June 2026), Fred van Zwieten and Ismail Dhaoui revealed how the Ansible VS Code extension now embeds an **MCP (Model Context Protocol) server** — turning your IDE into an AI-powered automation development environment.
...
![Ansible Development Workspaces - AI-powered tools on OpenShift Dev Spaces](/blog/events/rh-tech-day-nl-openclaw-36.jpg)
