...
seoTitle: "apt Cheat Sheet: Ubuntu/Debian Package Management"
snippet: "APT cheat sheet for Ubuntu and Debian. Install, update, remove, search, pin versions, manage repos, and troubleshoot broken packages — all essential commands."
description: "APT package manager cheat sheet for Ubuntu and Debian. Install, update, remove, search, version pinning, repository management, and broken package fixes."
image:
