---
draft: false
title: "Autoscale AI Inference on Kubernetes: HPA and KEDA"
seoTitle: "Autoscale AI Inference on K8s: HPA & KEDA"
snippet: "Inference autoscaling is harder because every extra replica means another GPU and cold-start penalty. Custom metrics like tokens/second are essential."
description: "Inference autoscaling is harder because every extra replica means another GPU and cold-start penalty. Custom metrics like tokens/second are essential."
