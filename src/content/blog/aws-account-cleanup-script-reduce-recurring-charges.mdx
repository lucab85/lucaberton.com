---
draft: false
title: "AWS Account Cleanup Script: Stop Paying for Resources You Forgot About"
snippet: "A battle-tested Bash script that audits and removes unused AWS resources across all regions — GuardDuty, AWS Config, EC2, EBS, Elastic IPs, NAT Gateways, S3, and SSM managed instances. Dry-run by default."
