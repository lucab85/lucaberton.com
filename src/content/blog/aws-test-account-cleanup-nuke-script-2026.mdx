...
snippet: "A production-ready bash script to permanently delete all resources in a disposable AWS test account, covering CloudWatch, CloudTrail, Config, GuardDuty, KMS, Kinesis, RDS, S3, WAF, Lambda, SNS, SQS, EC2, EBS, NAT Gateways, and Elastic IPs."
