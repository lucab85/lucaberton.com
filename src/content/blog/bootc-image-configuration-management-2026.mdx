...
snippet: "How to combine bootc immutable OS images with runtime configuration for production Linux. Build the golden image, layer site-specific config, and update."
