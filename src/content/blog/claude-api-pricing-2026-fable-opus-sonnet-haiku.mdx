...
seoTitle: "Claude API Pricing 2026: Token Costs, Cache & Batch"
snippet: "Claude 2026 pricing: Fable $10/MTok, Opus $25/MTok, Sonnet 5 $2/MTok. Complete token table, cache rates, batch savings."
description: "Complete 2026 Claude API pricing: Fable 5, Opus 4.8, Sonnet 5 intro pricing, Haiku 4.5 token costs. Input/output prices, cache write/read rates, batch discounts, and cost optimization strategies."
...
The important point is that Claude cost is not just "input price plus output price." Prompt caching, batch processing, web search, code execution, managed agent runtime, service tier, and data residency can all change the real bill. As covered in [How I Cut My Client's OpenAI Bill by 80%](/blog/ai-cost-optimization-openai-bill-80-percent/), model routing is the single biggest lever for API cost control.

See also: [Sonnet 5: Opus-Level Agentic Performance at Sonnet Prices](/blog/claude-sonnet-5-agentic-model-2026/).
...
- [How I Cut My Client's OpenAI Bill by 80%](/blog/ai-cost-optimization-openai-bill-80-percent/) — cost optimization strategies for AI API usage
- [Sonnet 5: Opus-Level Agentic Performance at Sonnet Prices](/blog/claude-sonnet-5-agentic-model-2026/) — why Sonnet 5 replaced both Sonnet 4.6 and Opus for agentic coding
- [AI Cost Optimization: Cut Your Bill by 80%](/blog/ai-cost-optimization-openai-bill-80-percent/) — practical techniques for model routing and batch processing
- [AI Infrastructure Cost Optimization (2026)](/blog/ai-infrastructure-optimization-2026/) — beyond model pricing, the infrastructure cost levers
