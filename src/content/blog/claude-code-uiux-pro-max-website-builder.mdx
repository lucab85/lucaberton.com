...
seoTitle: "UI/UX Pro Max: Claude Code Skill for Web Design"
...
description: "UI/UX Pro Max is a Claude Code skill combining design rules with Framer Motion and 21st.dev to generate fully designed, animated websites in minutes."
