...
**UI/UX Pro Max is a Claude Code skill** — a structured instruction set that teaches Claude to generate polished, animated, agency-quality website designs, pairing built-in design rules with Framer Motion and 21st.dev components so you can build a professional site without hiring a designer.
