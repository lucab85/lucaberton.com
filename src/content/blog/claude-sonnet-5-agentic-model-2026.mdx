...
seoTitle: "Claude Sonnet 5: Pricing, API & Benchmarks (2026)"
snippet: "Claude Sonnet 5 closes the gap with Opus 4.8 on agentic tasks. Intro pricing: $2/MTok input through August 2026. Benchmarks, API model ID, and what changed."
description: "Claude Sonnet 5 API pricing, model ID, benchmarks vs Sonnet 4.6 and Opus 4.8, tokenizer changes, and migration notes for developers."
