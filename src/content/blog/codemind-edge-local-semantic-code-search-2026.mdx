...
snippet: "CodeMind Edge is a local, privacy-first semantic code search engine built with Qdrant Edge. Ask plain-English questions and find relevant code instantly."
description: "CodeMind Edge uses Qdrant Edge for local semantic code search. No cloud, no GPU, no Docker. Parse repos into function chunks, embed locally via fastembed."
