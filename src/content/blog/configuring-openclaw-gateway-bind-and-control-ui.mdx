...
description: "End-to-end walkthrough configuring OpenClaw gateway.bind together with gateway.controlui.allowedorigins for loopback, LAN, Tailscale, and reverse-proxy."
