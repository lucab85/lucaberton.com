...
seoTitle: "Connect Hermes Agent to Discord 2026: Bot Setup Guide"
snippet: "Step-by-step: create the Discord bot, enable Message Content Intent, and wire up the gateway to connect Hermes Agent — done in under 10 minutes."
description: "Step-by-step: create the Discord bot, enable Message Content Intent, and wire up the gateway to connect Hermes Agent — done in under 10 minutes."
