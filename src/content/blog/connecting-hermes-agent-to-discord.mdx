...
seoTitle: "Connect Hermes Agent to Discord 2026: Bot & Gateway Config"
snippet: "Connect Hermes Agent to Discord in 2026: create the bot, enable Message Content Intent, configure the gateway, and fix 'bot online but not responding' errors."
...
- For deeper auth, model 404, rate-limit, and gateway error troubleshooting, see [Hermes Agent Troubleshooting Guide](/blog/hermes-agent-troubleshooting/).
