...
snippet: "Setup Hermes Agent on Discord: create the bot, enable Message Content Intent, configure the gateway."
description: "Complete guide: connect Hermes Agent to Discord with step-by-step bot creation, permissions, config, and troubleshooting."
