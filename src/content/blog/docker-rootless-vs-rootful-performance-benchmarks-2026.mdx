---
draft: false
title: "Docker Rootless vs Rootful: Performance Benchmarks 2026"
seoTitle: "Docker Rootless vs Rootful: p95/p99 Benchmarks 2026"
snippet: "Docker rootless is 18-25% slower to start than rootful (p95 224ms vs 187ms) and supports ~30% fewer max containers. Full p50/p95/p99 benchmarks inside."
...
**Quick answer**: Docker rootless adds ~18-25% cold start latency versus rootful (p95: 224ms vs 187ms, p99: 289ms vs 231ms), plus ~3 MB more memory overhead per container (7 MB vs 4 MB) and roughly 30% lower container density (~8,500 vs ~12,000 max containers on 256 GB RAM). Full p50/p95/p99 benchmarks below.
...
Networking is where rootless historically suffered most. If slirp4netns performance is the bottleneck, here are the alternatives:
...
- [CRI-O vs containerd: Kubernetes Runtime Comparison](/blog/containerd-vs-cri-o-2026/)
- [Install Podman on Ubuntu 24.04](/blog/install-podman-ubuntu-2404/)
