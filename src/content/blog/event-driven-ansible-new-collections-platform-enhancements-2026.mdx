...
snippet: "Everything new in Event-Driven Ansible and AAP 2.7: 12 content collections, Azure/AWS event bus, gateway-only architecture, PostgreSQL 17, Django 5.2."
