---
title: "FIO Storage Benchmarks for AI Training: NFS and SMB on"
snippet: "How to benchmark shared storage performance for distributed AI training workloads using FIO on Kubernetes. Covers NFS vs SMB throughput, IOPS patterns."
