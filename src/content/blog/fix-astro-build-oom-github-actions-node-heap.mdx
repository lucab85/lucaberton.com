---
draft: false
title: "Fix Astro Build Out-of-Memory on GitHub Actions: Bump"
snippet: "Astro builds with heavy image optimization can OOM on GitHub Actions runners with exit code 134. Set NODE_OPTIONS=--max-old-space-size=6144 on the build."
