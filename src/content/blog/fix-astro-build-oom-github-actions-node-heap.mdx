...
snippet: "Astro builds with heavy image optimization can OOM on GitHub Actions runners. Set NODE_OPTIONS=--max-old-space-size=6144 on the build step to fix exit code 134."
description: "Astro build failing with 'JavaScript heap out of memory' on GitHub Actions? Bump Node's max-old-space-size to 6144 MB on the pnpm build step. Working YAML included."
