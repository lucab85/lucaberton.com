...
description: "Diagnose and fix the 'unauthorized: gateway token mismatch' WebSocket error in OpenClaw. Learn how gateway auth tokens work, why token_mismatch happens after."
