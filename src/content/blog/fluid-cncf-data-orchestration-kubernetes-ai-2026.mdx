...
description: "Fluid CNCF incubating project for Kubernetes data orchestration. Elastic datasets, multi-tier caching, and data acceleration for AI and machine learning workloads."
image:
