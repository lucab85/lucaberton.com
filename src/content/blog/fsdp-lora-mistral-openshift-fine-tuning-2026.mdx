...
description: "A production guide to fine-tuning Mistral models using FSDP2, LoRA/PEFT, and Run:ai on OpenShift with InfiniBand RDMA. Covers NCCL configuration, memory."
