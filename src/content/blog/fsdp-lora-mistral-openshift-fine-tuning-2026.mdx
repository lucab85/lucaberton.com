...
- **PyTorch container**: `nvcr.io/nvidia/pytorch:26.02` (CUDA 12.8, PyTorch 2.6)
...
uv pip install peft trl accelerate
# transformers must be latest (or from main) for Mistral4ForCausalLM
