---
title: "Garry Tan's gstack: 23 Claude Code Specialists That Ship"
seoTitle: "Garry Tan's gstack: 23 Claude Code Specialists That Ship"
snippet: "Y Combinator CEO Garry Tan open-sourced gstack — 23 Claude Code slash commands that turn one developer into a virtual engineering team. CEO, designer, QA."
...
- [GBrain: Garry Tan's Self-Wiring Knowledge Graph for AI](/blog/garry-tan-gbrain-ai-agent-knowledge-graph-2026/)

## Master Claude Code

Want to build your own gstack-style workflow? These resources will get you there:

- 🎓 **[Claude Code Masterclass (Free on Udemy)](https://www.udemy.com/course/claude-code-masterclass-ai-coding/)** — 13 lectures covering CLAUDE.md, hooks, MCP servers, and autonomous coding patterns
- 📘 **[Claude Code Companion Book (Leanpub)](https://leanpub.com/claude-code)** — Deep dive into enterprise patterns, team workflows, and production Claude Code setups
- 📝 **[5 Claude Code Mods That Make It Production-Ready](/blog/claude-code-mods-production-ready-workflow-2026/)** — Ralph Loop, Ultracode, Context7, and more
