---
title: "GenAI-Perf: Benchmarking LLM Inference with NVIDIA's"
snippet: "How to benchmark vLLM inference endpoints using NVIDIA GenAI-Perf from multiple network locations. Covers token throughput, latency percentiles."
description: "How to benchmark vLLM inference endpoints using NVIDIA GenAI-Perf from multiple network locations. Covers token throughput, latency percentiles, concurrency."
...
Before putting an LLM into production, you need to answer: how many concurrent users can this deployment handle? What's the P99 latency? What happens under load? NVIDIA's **GenAI-Perf** has long been the standard tool for answering these questions against vLLM, TensorRT-LLM, and NIM endpoints.

**Note:** NVIDIA is phasing out GenAI-Perf in favor of its actively-maintained successor, **AIPerf**. The commands and metrics below still apply to existing GenAI-Perf installs, but new benchmarking work should use AIPerf — see the [NVIDIA AIPerf guide](/blog/nvidia-aiperf-llm-inference-benchmarking-guide/) for the current install and usage instructions.
...
- [NVIDIA NIM Support Matrix](/blog/nvidia-nim-support-matrix-models-gpus-profiles-2026/) — supported model/GPU combinations
- [NVIDIA NIM Model Profiles](/blog/nvidia-nim-model-profiles-selection-guide-2026/) — performance profile selection
- [The Inference Economy](/blog/inference-economy-venture-capital-agentic-ai-2026/) — cost optimization strategies
- [LLM Quality vs Cost vs Safety](/blog/llm-quality-vs-cost-frontier-models-2026/) — trade-off analysis
