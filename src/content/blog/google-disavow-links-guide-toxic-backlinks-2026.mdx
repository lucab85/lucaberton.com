---
draft: false
title: "How to Disavow Links in Ahrefs & Search Console"
snippet: "Step-by-step guide to using Google's Disavow Links tool. Find toxic backlinks with Ahrefs and Google Search Console, build a disavow file, and protect."
description: "Learn how to disavow links found in Ahrefs: identify toxic backlinks, build a disavow file, and submit it via Google Search Console."
image:
...
**Quick answer:** Ahrefs does not have a built-in "disavow" button. You use Ahrefs to find the toxic backlinks (Site Explorer → Backlinks, sorted by Domain Rating), then list those domains in a plain-text disavow file and submit it through Google Search Console. The full workflow, from finding links in Ahrefs to submitting the file, is below.
