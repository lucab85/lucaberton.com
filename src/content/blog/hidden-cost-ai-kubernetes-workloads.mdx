...
| Time to deploy | From model approval to production serving | <1 hour |
| Waste ratio | Idle + failed GPU hours / total GPU hours | <20% |
| Platform ops cost | Engineering hours on platform operations / total engineering hours | <15% |
