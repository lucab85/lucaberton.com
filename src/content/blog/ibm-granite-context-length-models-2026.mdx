...
snippet: "IBM Granite model context lengths, parameter counts, and deployment specs. Covers granite-3b-instruct, granite-8b-base, granite-8b-instruct and all."
