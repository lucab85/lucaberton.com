...
![Inko meetup — test statistics slide](/blog/events/inko-meetup-test-statistics.jpg)
...
- CI takes **11-12 minutes** across Linux, macOS, and FreeBSD
- Could be half that if GitHub Actions supported FreeBSD natively

### Table-Driven Tests

![Inko meetup — table-driven tests expanding one test into 100 assertions](/blog/events/inko-meetup-table-driven-tests.jpg)
...
![Inko meetup — stdlib tests are algorithmic, unit tests make more sense here](/blog/events/inko-meetup-stdlib-tests.jpg)
...
![Inko meetup — StringBuffer test with emoji support](/blog/events/inko-meetup-stdlib-test-code.jpg)
...
![Inko meetup — borrow checker challenge: iterating while mutating self](/blog/events/inko-meetup-borrow-checker-challenge.jpg)
...
![Inko meetup — borrow checker workarounds](/blog/events/inko-meetup-borrow-checker-workarounds.jpg)

The workarounds are all unsatisfying:

- `slice::get_disjoint_mut` can help, but comes with runtime cost
- Using **IDs instead of borrows** works but adds indirection
...
![Inko meetup — deep nesting from borrowing multiple self fields](/blog/events/inko-meetup-borrow-checker-nesting.jpg)
...
![Inko meetup — struct + enum is more flexible than pure enum for TypeRef](/blog/events/inko-meetup-enums-rigid.jpg)
...
![Inko meetup — pattern matching is much better than Java visitor pattern](/blog/events/inko-meetup-tip-pattern-matching.jpg)
...
![Inko meetup — only 168 unsafe blocks in the entire Inko compiler](/blog/events/inko-meetup-tip-reduce-unsafe.jpg)
...
![Inko meetup — fewer macros = better compile times and tooling support](/blog/events/inko-meetup-tip-reduce-macros.jpg)
...
![Inko meetup — Inko compiler builds in 5-15 seconds](/blog/events/inko-meetup-tip-compile-times.jpg)
...
![Inko meetup — compiler has only 5 direct dependencies](/blog/events/inko-meetup-tip-reduce-deps.jpg)

- The **compiler** has **5 direct dependencies**
- The **runtime** has **10 direct dependencies** + a vendored version of `rustls-platform-modifier`
- Inko first used a custom setup for I/O, then moved to the `polling` crate, then **back to a custom setup**
...
![Inko meetup — conclusion slide](/blog/events/inko-meetup-conclusion.jpg)
...
![Inko meetup — learn more with QR code and links](/blog/events/inko-meetup-learn-more.jpg)

- Creator's site: [yorickpeterse.com](https://yorickpeterse.com)
- Language site: [inko-lang.org](https://inko-lang.org)
- Source code: [github.com/inko-lang/inko](https://github.com/inko-lang/inko)
