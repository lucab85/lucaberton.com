---
title: "Inko: The Rust-Compiled Language with Erlang-Style"
seoTitle: "Inko: The Rust-Compiled Language with Erlang-Style"
snippet: "Inko is a new programming language that compiles to native code via Rust's LLVM backend. It combines single-ownership memory management with Erlang-style."
