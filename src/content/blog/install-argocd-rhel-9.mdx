...
snippet: "Install ArgoCD on RHEL 9 in 2026. Official repository setup, package installation, post-install configuration, and troubleshooting."
...
Here is how to install the ArgoCD CLI on RHEL 9. Tested and verified.
...
The ArgoCD CLI has no `dnf` package and no official RPM repository — the project does not publish one. The supported installation method is downloading the prebuilt static binary for your CPU architecture directly from the [ArgoCD GitHub releases page](https://github.com/argoproj/argo-cd/releases). This step is identical across every Linux distribution; there is nothing RHEL-specific about it.
