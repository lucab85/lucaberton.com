---
draft: false
title: "Install ArgoCD on Rocky Linux 9: Complete Guide (2026)"
snippet: "Install ArgoCD on Rocky Linux 9 in 2026. Official repository setup, package installation, post-install configuration, and troubleshooting."
description: "Install ArgoCD on Rocky Linux 9 in 2026. Official repository setup, package installation, post-install configuration, and troubleshooting."
image:
  src: "/blog/thumbnails/install-argocd-rocky-9.jpg"
  alt: "Install ArgoCD on Rocky Linux 9"
publishDate: "2026-04-04"
lastModified: "2026-04-04"
author: "Luca Berton"
category: "DevOps"
tags: ["ArgoCD", "Rocky Linux 9", "Installation", "Linux", "DevOps"]
---

Here is how to install the ArgoCD CLI on Rocky Linux 9. Tested and verified.
...
The ArgoCD CLI has no `dnf` package and no official RPM repository — the project does not publish one. The supported installation method is downloading the prebuilt static binary for your CPU architecture directly from the [ArgoCD GitHub releases page](https://github.com/argoproj/argo-cd/releases). This step is identical across every Linux distribution; there is nothing Rocky-specific about it.
