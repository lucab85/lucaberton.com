---
draft: false
title: "Install AWS CLI with Homebrew on Mac"
seoTitle: "Brew Install AWS CLI on Mac (2026 Guide)"
snippet: "Install AWS CLI with Homebrew on Mac: run brew install awscli, then configure profiles, SSO login, autocompletion, and troubleshooting."
description: "Install AWS CLI v2 on Mac using Homebrew: brew install awscli in one command, with setup, profiles, SSO, shell completion, and troubleshooting."
