...
description: "Install AWS CLI v2 on macOS with a single brew install awscli command. Covers profile setup, SSO login, autocomplete, and troubleshooting fixes."
