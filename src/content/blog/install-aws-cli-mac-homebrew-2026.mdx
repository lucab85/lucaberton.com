...
snippet: "Step-by-step guide to install, configure, and verify AWS CLI v2 on macOS using Homebrew. Includes profile setup, SSO login, autocompletion, and common troubleshooting fixes."
