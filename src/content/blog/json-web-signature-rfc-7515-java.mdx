---
draft: false
title: "JWS in Java: RFC 7515 Implementation (Code Examples)"
seoTitle: "JWS in Java: RFC 7515 Implementation (Code Examples)"
snippet: "RFC 7515 JWS compact serialization explained. Three-part structure, Base64URL encoding, HMAC and RSA signatures, with full Java examples using jjwt."
description: "RFC 7515 JWS compact serialization in Java: three Base64URL parts, signing input, and examples for HMAC, RSA, and EC algorithms."
...
**RFC 7515 compact serialization has exactly three parts:** `BASE64URL(UTF8(header))`, `BASE64URL(payload)`, and `BASE64URL(signature)`. The signing input is the first two parts joined with a dot.
