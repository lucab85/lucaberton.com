...
seoTitle: "Karpathy Rules for CLAUDE.md: 4 LLM Coding Principles"
snippet: "Karpathy rules for LLM coding: clarify ambiguity, keep code simple, make surgical edits, and define success before implementation."
...
In short, the **Karpathy rules** for LLM coding are: ask when ambiguous, prefer the simplest working change, touch only the files needed, and define verification before coding. The rest of this post breaks those four rules into a practical `CLAUDE.md` pattern.
