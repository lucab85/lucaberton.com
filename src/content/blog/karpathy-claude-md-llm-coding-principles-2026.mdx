...
snippet: "Andrej Karpathy's CLAUDE.md guidelines turn LLM coding discipline into 4 rules: clarify ambiguity, keep code simple, change surgically, and verify done."
description: "Andrej Karpathy's CLAUDE.md guidelines for Claude Code: 4 rules for assumptions, simple code, narrow edits, and goal-driven verification."
