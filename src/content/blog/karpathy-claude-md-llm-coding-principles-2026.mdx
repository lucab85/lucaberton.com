---
title: "Karpathy's claude.md: 4 Rules for Better LLM Coding"
seoTitle: "Karpathy claude.md Guidelines: 4 Rules for LLM Coding"
snippet: "Karpathy's claude.md: 4 rules that fix LLM coding mistakes. Eliminate silent assumptions, overcomplexity, scope creep, and vague execution in AI development."
description: "Karpathy's claude.md guidelines: 4 rules for better LLM coding with Claude Code. Eliminate silent assumptions, overcomplexity, and scope creep."
...
If you searched for "Andrej Karpathy claude.md" or "Karpathy Claude md", this is the practical takeaway: use a project-level `CLAUDE.md` to turn Andrej Karpathy's coding-agent guidelines into repeatable instructions for Claude Code.
...
**Karpathy's 4 rules, at a glance:**

1. **Think Before Coding** — surface ambiguity instead of guessing
...
- [Gemini CLI: Complete Guide to Commands & Automation](/blog/gemini-cli-complete-guide-commands-automation-2026/)

## Go Deeper with Claude Code

Ready to implement Karpathy's principles and beyond?

- 🎓 **[Claude Code Masterclass (Free on Udemy)](https://www.udemy.com/course/claude-code-masterclass-ai-coding/)** — Full course: CLAUDE.md, hooks, MCP servers, autonomous workflows
- 📘 **[Claude Code Companion Book (Leanpub)](https://leanpub.com/claude-code)** — Enterprise patterns, team setups, and production best practices
- 📝 **[5 Mods That Make Claude Code Production-Ready](/blog/claude-code-mods-production-ready-workflow-2026/)** — Ralph Loop, Ultracode, Context7
