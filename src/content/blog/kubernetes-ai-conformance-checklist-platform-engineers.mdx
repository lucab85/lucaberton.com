...
description: "Kubernetes AI Conformance implementation checklist for platform engineers. GPU device plugins, DRA, topology scheduling, inference autoscaling, and agentic patterns."
image:
...
For a deep dive on GPU management, see [NVIDIA GPU Operator for Kubernetes](/blog/nvidia-gpu-operator-kubernetes-ai-ml/).
...
For SR-IOV details, see [SR-IOV NIC Cluster Policy for Kubernetes](/blog/sriov-nicclusterpolicy-kubernetes-high-performance-networking/).
