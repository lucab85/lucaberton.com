...
- [Kubernetes Recipes Book](/blog/kubernetes-recipes-book-giveaway-kubecon-europe-2026/) — my Kubernetes book
- [AI on Kubernetes in Production Series](/blog/ai-kubernetes-production-first-90-days/)
- [Multi-Tenant GPUs on Bare Metal](/blog/kubecon-2026-packed-room-multi-tenant-gpus/)
