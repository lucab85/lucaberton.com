...
snippet: "Why cluster-scoped Kubernetes Pod Disruption Budgets can silently break quorum for multi-cloud CockroachDB, and how a custom cross-cluster PDB fixes it."
