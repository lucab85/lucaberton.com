---
draft: false
title: "Kubescape 4.0: Kubernetes Security for the AI Era (Runtime Threat Detection GA)"
...
description: "Kubescape 4.0 release analysis. GA runtime threat detection with CEL rules, AI agent security scanning, and aggregated API storage for enterprise-scale clusters."
image:
...
This aligns with what I have been writing about in the [AI on Kubernetes series](/blog/ai-kubernetes-production-why-platform-teams-need-ai-strategy/) — as AI moves into production, security must evolve with it.
