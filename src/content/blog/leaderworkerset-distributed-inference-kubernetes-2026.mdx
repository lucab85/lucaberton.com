...
description: "Deploy large language models across multiple Kubernetes nodes using the LeaderWorkerSet (LWS) operator. Covers vLLM pipeline parallelism, NCCL over InfiniBand."
