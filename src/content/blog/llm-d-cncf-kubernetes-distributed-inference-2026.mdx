...
seoTitle: "llm-d: CNCF Distributed LLM Inference on K8s"
snippet: "llm-d is the CNCF's new sandbox project for distributed LLM inference on Kubernetes. Covers prefill/decode disaggregation, KV cache routing, and LoRA."
description: "llm-d joins CNCF as a sandbox project. Kubernetes-native distributed inference with prefill/decode disaggregation, cache-aware routing."
image:
