---
draft: false
title: "How to Enable Priority Flow Control (PFC) on Mellanox ConnectX NICs for Lossless RDMA Networking"
...
description: "A complete guide to configuring Priority Flow Control (PFC) on Mellanox/NVIDIA ConnectX adapters. Covers mlnx_qos, lldptool, switch-side configuration, RoCEv2 traffic class mapping, and troubleshooting — essential for AI training clusters and HPC workloads that require lossless Ethernet."
...
- [NVIDIA NIM Multi-Node Inference on Kubernetes](/blog/nvidia-nim-multi-node-kubernetes-deployment/)
- [GPU Operator and SR-IOV NicClusterPolicy](/blog/nvidia-gpu-operator-sriov-nicclusterpolicy-kubernetes/)
