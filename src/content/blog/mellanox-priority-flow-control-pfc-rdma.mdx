...
seoTitle: "Enable PFC on Mellanox ConnectX NICs for"
snippet: "A complete guide to configuring Priority Flow Control (PFC) on Mellanox/NVIDIA ConnectX adapters. Covers mlnx_qos, lldptool, switch-side configuration."
