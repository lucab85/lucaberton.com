...
description: "Mistral Small 4 unifies instruct, reasoning, and coding into a single 119B MoE model with 128 experts, 6.5B active per token, 256K context, and Apache 2.0."
