...
- Better patterns for building [internal developer platforms](/blog/internal-developer-platforms-2026/) that serve ML workloads
...
- **Kyverno** and other policy engines started handling [ML-specific governance](/blog/kyvernocon-virtual-2026-policy-as-code/)
...
As someone who speaks at both [KubeCon](/kubecon/) and Red Hat Summit about [GPU multi-tenancy](/blog/kubecon-2026-talk-multi-tenant-gpus-recap/) and [AI platform engineering](/blog/ai-platform-first-90-days-kubernetes/), I have seen these two worlds collide daily. Platform teams building for ML workloads need MLOps patterns. ML engineers deploying to production need Kubernetes knowledge.
...
- [NVIDIA NIM on Kubernetes](/blog/nvidia-nim-multi-node-deployment-helm-kubernetes-2026/)
