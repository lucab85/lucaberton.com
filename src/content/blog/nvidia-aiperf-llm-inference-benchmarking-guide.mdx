---
title: "NVIDIA aiperf: Benchmark LLM Inference (TTFT, ITL, Throughput)"
seoTitle: "Aiperf: NVIDIA LLM Benchmarking Tool (Complete Guide)"
snippet: "Benchmark LLM inference with Aiperf. Measure TTFT, ITL, throughput on vLLM, NIM, TGI with production-grade metrics and realistic traffic patterns."
description: "Benchmark LLM inference with Aiperf. Measure TTFT, ITL, throughput on vLLM, NIM, TGI with production-grade metrics and realistic traffic patterns."
...
- [GenAI-Perf: NVIDIA's Legacy LLM Benchmarking Tool](/blog/genai-perf-nvidia-llm-benchmarking-2026/) — the tool AIPerf replaces
