...
snippet: "AIPerf is NVIDIA's open-source LLM benchmarking tool (formerly GenAI-Perf): TTFT, ITL, throughput, latency on vLLM, NIM, TGI. Install and config tips."
description: "AIPerf is NVIDIA's open-source LLM benchmarking tool (formerly GenAI-Perf): TTFT, ITL, throughput, latency on vLLM, NIM, TGI. Install and config tips."
