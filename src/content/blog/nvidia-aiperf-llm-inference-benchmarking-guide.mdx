...
snippet: "AIPerf is NVIDIA's open-source tool for benchmarking generative AI inference — measuring TTFT, ITL, throughput, and latency across vLLM, NIM, TGI, and any."
