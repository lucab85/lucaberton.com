...
snippet: "AIPerf (formerly GenAI-Perf) is NVIDIA's open-source LLM benchmarking tool. Install with pip, measure TTFT, ITL, throughput, and goodput in 5 minutes."
description: "Complete guide to AIPerf: NVIDIA's LLM benchmarking tool. Measure TTFT, ITL, throughput, and goodput with real examples and best practices."
