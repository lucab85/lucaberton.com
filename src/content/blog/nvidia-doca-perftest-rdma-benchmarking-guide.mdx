...
description: "NVIDIA DOCA Perftest guide for RDMA benchmarking on BlueField DPUs. CLI and JSON modes, GPU memory, traffic patterns, bandwidth/latency tests, and SLURM integration."
