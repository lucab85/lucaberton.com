...
snippet: "How to use DOCA Perftest to benchmark RDMA performance on BlueField-3 DPUs. Covers CLI and JSON modes, GPU memory types, traffic patterns, bandwidth and."
