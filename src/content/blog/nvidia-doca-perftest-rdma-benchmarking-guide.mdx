---
title: "NVIDIA DOCA Perftest: RDMA Benchmarking Guide"
seoTitle: "NVIDIA DOCA Perftest: RDMA Benchmarking Guide"
snippet: "How to use DOCA Perftest to benchmark RDMA on BlueField-3 DPUs. Covers CLI and JSON modes, GPU memory types, traffic patterns, bandwidth and latency."
