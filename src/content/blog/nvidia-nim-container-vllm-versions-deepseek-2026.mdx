---
title: "NVIDIA NIM Container vLLM Versions: What Is Inside nvcr.io/nim Images (2026)"
...
description: "Find the exact vLLM version inside NVIDIA NIM containers including DeepSeek-R1, Qwen3, and Granite models. Inspect nvcr.io/nim images, check PyTorch and CUDA versions, and understand the NIM inference stack."
...
3. For custom vLLM, use the [NIM model-free approach](/blog/nvidia-nim-model-free-custom-model-deployment-guide/)
...
- [NVIDIA NIM Model-Free and Custom Model Deployment Guide](/blog/nvidia-nim-model-free-custom-model-deployment-guide/)
