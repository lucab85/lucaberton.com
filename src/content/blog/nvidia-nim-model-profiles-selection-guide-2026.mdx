---
draft: false
title: "NIM Model Profiles Explained: Pick the Right GPU Config"
seoTitle: "NIM Model Profiles: Pick the Right Config"
snippet: "NIM model profiles control precision, parallelism, and backend for your LLM. Covers profile naming conventions, GPU memory tiers, selection chain priority."
description: "Understand NVIDIA NIM model profiles — naming conventions, GPU memory tiers, throughput vs latency trade-offs, and how to override defaults with vLLM CLI."
image:
...
- [Deploy Custom Models on NIM Without NGC](/blog/nvidia-nim-model-free-custom-model-deployment-guide-2026/)
