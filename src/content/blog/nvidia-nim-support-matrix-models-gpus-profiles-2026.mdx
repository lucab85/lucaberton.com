---
draft: false
title: "NVIDIA NIM Support Matrix: Every Model × GPU × Profile"
seoTitle: "NVIDIA NIM Support Matrix 2026: Models, GPUs & Profiles"
snippet: "Complete 2026 NIM LLM support matrix: which models run on which GPUs, precision profiles (BF16, FP8, NVFP4, MXFP4), TP configs, and LoRA adapter support."
description: "Complete 2026 NIM LLM support matrix: which models run on which GPUs, precision profiles (BF16, FP8, NVFP4, MXFP4), TP configs, and LoRA adapter support."
image:
...
export const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Which GPUs are supported by NVIDIA NIM?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "NVIDIA NIM supports A100 (40/80GB), H100, H200, L40S, L4, and A10G GPUs. Model availability varies by GPU memory."
      }
    },
    {
      "@type": "Question",
      "name": "Can I run NIM on consumer GPUs like RTX 4090?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "NIM is designed for data center GPUs. Consumer GPUs are not officially supported, though smaller models may work with vLLM directly."
      }
    }
  ]
};
