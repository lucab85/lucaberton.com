...
snippet: "The complete NIM LLM support matrix. Which models run on which GPUs, available precision profiles (BF16, FP8, NVFP4, MXFP4), TP configurations, LoRA."
description: "Complete 2026 compatibility table for NVIDIA NIM inference microservices. Which models run on which GPUs, memory requirements, and profile configurations."
image:
