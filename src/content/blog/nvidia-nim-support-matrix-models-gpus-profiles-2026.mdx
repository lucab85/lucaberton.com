---
draft: false
title: "NVIDIA NIM Support Matrix: Every Model, GPU, and Profile in One Place (2026)"
...
description: "Complete NVIDIA NIM LLM support matrix for 2026. Supported models, verified GPUs, deployment profiles per precision and tensor parallelism, LoRA support, and 1.x legacy model reference."
image:
