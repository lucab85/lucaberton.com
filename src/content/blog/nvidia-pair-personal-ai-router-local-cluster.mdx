...
snippet: "NVIDIA launches PAIR, free open-source software that links computers on the same network and pools unused compute for local AI across RTX, DGX Spark, and Mac."
description: "NVIDIA launches PAIR (Personal AI Router), free open-source software that links computers on the same network and pools unused compute for local AI. Supports RTX 20-series+, RTX PRO, DGX Spark, and Apple M4+ Macs."
image:
