...
snippet: "NVIDIA Run:ai v2.23 with Dynamo enables gang scheduling and topology-aware placement for disaggregated prefill/decode inference workloads on GPU clusters."
