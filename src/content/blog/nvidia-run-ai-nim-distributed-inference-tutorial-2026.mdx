---
draft: false
title: "Tutorial: Deploy DeepSeek-R1 Distributed Inference with NVIDIA Run:ai and NIM"
...
description: "Step-by-step tutorial for deploying DeepSeek-R1 distributed inference with NVIDIA Run:ai. Access keys, NGC credentials, PVC data sources, leader-worker configuration, and API testing."
image:
