...
seoTitle: "Deploy DeepSeek-R1 671B Distributed with Run:ai + NIM"
snippet: "Step-by-step tutorial deploying DeepSeek-R1 671B across 2 nodes with NVIDIA Run:ai. Covers Leader-Worker Sets, NIM profiles, SGLang runtime, and PVC caching."
