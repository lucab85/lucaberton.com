...
description: "Complete guide to NVIDIA Run:ai topology-aware scheduling. Configure network topology from node labels, automatic and fine-tuned placement for distributed GPU workloads, LeaderWorkerSet per-replica scheduling, and pod affinity comparison."
image:
...
- [Multi-Tenant GPUs on Bare Metal](/blog/kubecon-europe-2026-multi-tenant-gpus-bare-metal-talk/)
