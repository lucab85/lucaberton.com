---
draft: false
title: "Run:ai Topology-Aware Scheduling for GPU Workloads (2026)"
seoTitle: "Run:ai Topology-Aware GPU Scheduling Guide (2026)"
snippet: "Run:ai topology-aware scheduling places GPU workloads on nodes close in the network hierarchy. Configure topology labels and preferred or required modes."
description: "Complete guide to NVIDIA Run:ai topology-aware scheduling. Configure network topology from node labels. Run:ai topology-aware scheduling places distributed."
image:
