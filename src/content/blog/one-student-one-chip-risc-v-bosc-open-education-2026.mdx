---
title: "One Student One Chip: 18,861 Students Build RISC-V Chips"
seoTitle: "One Student One Chip: 18,861 Students Build RISC-V Chips"
snippet: "BOSC's One Student One Chip teaches students to design RISC-V processors from ISA to GDSII tape-out. At RISC-V Summit Europe 2026, 18,861 enrollments revealed."
description: "BOSC's One Student One Chip teaches students to design RISC-V processors from ISA to GDSII tape-out. At RISC-V Summit Europe 2026, 18,861 enrollments revealed."
...
I also caught up with **Jan** on the Summit floor to talk through the initiative. What if every student could design — and actually *tape out* — their own RISC-V chip? That is exactly what One Student One Chip delivers: when a student finishes their design, the program **fabricates the chip for them, for free**, taking them beyond FPGA prototyping and simulation all the way to real silicon in their hands. So far it has shipped around **100 chips** to students — a wonderful example of how an open ISA lowers the barrier to chip design and grows the next generation of hardware engineers.

<YouTube id="RmI3xA9fdbU" title="One Student One Chip: teaching students to tape out RISC-V | RISC-V Summit Europe 2026" />
...
![OSOC Roadshow Event — mosaic of university visits across China with red banners](/blog/events/risc-v-summit-2026-osoc-15.jpg)
...
![Brought up Chips, Ran OS and Applications — student demos and video calls](/blog/events/risc-v-summit-2026-osoc-16.jpg)
...
![Demo by students — Chen Lu boots Linux from flash showing CAS logo on OSOC chip](/blog/events/risc-v-summit-2026-osoc-17.jpg)
...
![Chip and Board — from RTL layout to wafer to die to PCB, the full fabrication pipeline](/blog/events/risc-v-summit-2026-osoc-18.jpg)
