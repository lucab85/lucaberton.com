...
seoTitle: "OpenClaw 'Origin Not Allowed': allowedOrigins Fix"
snippet: "Fix the OpenClaw 'Origin not allowed' error: open the Control UI from the gateway host or allow it in gateway.controlui.allowedOrigins. Full config guide."
