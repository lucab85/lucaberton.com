---
draft: false
title: "gateway.controlui.allowedorigins — Complete Config Guide"
snippet: "How to configure gateway.controlui.allowedorigins for OpenClaw. Docker, LAN, Tailscale, reverse proxy examples. Fix origin not allowed errors permanently."
description: "How to configure gateway.controlui.allowedorigins for OpenClaw. Docker, LAN, Tailscale, reverse proxy examples. Fix origin not allowed errors."
image:
