---
draft: false
title: "gateway.controlui.allowedorigins — Reference Guide"
seoTitle: "OpenClaw gateway.controlui.allowedorigins — Complete Configuration Reference"
snippet: "Complete reference for OpenClaw gateway.controlui.allowedorigins: syntax, valid values, environment variable form, Docker / Tailscale / reverse-proxy examples, and troubleshooting."
description: "Complete reference for OpenClaw gateway.controlui.allowedorigins: syntax, valid values, env-var form, Docker / Tailscale / reverse-proxy examples, and troubleshooting."
image:
