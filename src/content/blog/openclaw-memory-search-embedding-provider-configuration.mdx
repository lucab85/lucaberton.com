...
snippet: "Configure OpenClaw memory search with local or API embeddings. Set agents.defaults.memorysearch.provider, choose sentence-transformer models, and."
