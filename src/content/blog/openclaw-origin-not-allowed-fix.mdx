---
draft: false
title: "Fix: OpenClaw origin not allowed - Open the Control UI from the Gateway Host or Allow It"
snippet: "The OpenClaw origin not allowed error means your browser URL does not match the gateway's allowed origins list. Here is how to diagnose and fix it in 60 seconds."
...
image:
  ...
  alt: "Fix: OpenClaw "origin not allowed" — Open the Control UI from the Gateway Host or Allow It"
---
