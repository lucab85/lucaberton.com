---
draft: false
title: "Running OpenClaw on a Raspberry Pi with GPT-5-mini: The Budget AI Agent Setup"
snippet: "Why a $35 Raspberry Pi paired with GPT-5-mini via GitHub Copilot Pro is the sweet spot for running OpenClaw. Skip the expensive GPU — cloud API models beat local inference for most use cases."
