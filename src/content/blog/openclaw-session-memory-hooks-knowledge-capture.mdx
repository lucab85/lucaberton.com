---
draft: false
title: "OpenClaw Memory Hooks: Auto-Save Context Between Sessions"
...
description: "Configure OpenClaw session memory hooks to automatically capture and recall knowledge across sessions. Setup guide with YAML examples and best practices."s session-memory hook — how it triggers on conversation events, integrates with memory flush, and automates durable knowledge capture."
