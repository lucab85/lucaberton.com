...
description: "Troubleshoot the OpenClaw SQLite memory database from empty files to permission errors. Bootstrap, migration, and recovery procedures explained."
