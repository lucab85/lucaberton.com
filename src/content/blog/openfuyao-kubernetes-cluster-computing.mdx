---
draft: false
title: "openFuyao: The Open Source Kubernetes Cluster Platform Built for 10,000+ Nodes and Heterogeneous AI"
snippet: "openFuyao is an open source computing cluster ecosystem built on Kubernetes with NUMA-aware scheduling, NPU/GPU operators, AI inference acceleration, and ultra-large cluster support. Here is what platform engineers should know."
description: "openFuyao is an open source computing cluster ecosystem built on Kubernetes with NUMA-aware scheduling, NPU/GPU operators, AI inference acceleration, and ultra-large cluster support. Here is what platform engineers should know."
...
- **NPU software-based allocation** — fractional NPU sharing (similar to [GPU MIG/MPS/time-slicing](/blog/gpu-sharing-kubernetes-mig-mps-time-slicing/) but for NPUs)
...
*Related: [openEuler: Enterprise Linux You Have Not Heard Of](/blog/openeuler-enterprise-linux-china-cloud/), [GPU Sharing on Kubernetes: MIG, MPS, Time-Slicing](/blog/gpu-sharing-kubernetes-mig-mps-time-slicing/), [Multi-Tenant GPU Platform Operating Model](/blog/multi-tenant-gpu-platform-operating-model/). Need help with cluster computing strategy? [Book a consultation](https://calendly.com/lucaberton/).*
