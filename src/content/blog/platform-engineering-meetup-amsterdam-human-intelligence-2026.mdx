...
description: "Recap of the Platform Engineering Amsterdam meetup at Tolhuistuin — agentic development efficiency, inner sourcing IDPs, and cloud migration war stories from the Amsterdam PE community."
snippet: "Recap of the Platform Engineering Amsterdam meetup at Tolhuistuin — agentic development efficiency, inner sourcing IDPs, and cloud migration war stories from the Amsterdam PE community."
...
If you are heading to [KubeCon Europe 2026 in Amsterdam](/blog/kubecon-europe-2026-side-events-amsterdam/), the Platform Engineering Amsterdam group is hosting an **Executive Roundtable on March 24** at NHOW Amsterdam RAI. Worth attending if you are a CTO/CIO looking to connect with peers on platform strategy.
