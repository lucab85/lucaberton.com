...
snippet: "I tried implementing Microsoft Entra External ID expecting an easy B2C setup with a future path to B2B and SSO. Here is what actually happened."
description: "I tried implementing Microsoft Entra External ID expecting an easy B2C setup with a future path to B2B and SSO. Here is what actually happened."
