---
draft: false
title: "ProteinLens: Vibe Coding on Azure and Quota Chaos"
snippet: "A behind-the-scenes build log of an AI meal-photo MVP on Azure (Static Web Apps, Functions, PostgreSQL, AI Foundry) — plus the real lessons from quotas,."
description: "A behind-the-scenes build log of an AI meal-photo MVP on Azure (Static Web Apps, Functions, PostgreSQL, AI Foundry) — plus the real lessons from quotas,."
