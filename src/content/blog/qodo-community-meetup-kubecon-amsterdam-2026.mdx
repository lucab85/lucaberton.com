---
draft: false
title: "Building Autonomous Systems: KubeCon Meetup with LangChain, SurrealDB, and Qodo in Amsterdam"
...
description: "Recap of the AMSTERDAM: Building Autonomous Systems KubeCon Meetup + AfterParty. Talks from LangChain (sandboxed deep agents, authorized AI apps), Qodo (hidden failure modes), SurrealDB (agent memory with knowledge graphs). Production-ready agent patterns."
image:
...
- [AI on Kubernetes: Agentic AI Architecture Decisions](/blog/ai-kubernetes-agentic-architecture-decisions/)
