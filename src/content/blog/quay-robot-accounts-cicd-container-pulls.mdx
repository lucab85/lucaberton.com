...
description: "How to create and use Quay.io robot accounts for secure, automated container image pulls in CI/CD pipelines without exposing personal credentials."
...
For teams running [OpenShift](https://lucaberton.com/kubecon/) or managing sensitive workloads, Red Hat Quay (the enterprise self-hosted version) adds:
