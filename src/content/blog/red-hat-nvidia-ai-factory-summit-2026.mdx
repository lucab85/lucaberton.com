---
draft: false
title: "Red Hat NVIDIA AI Factory: OpenShift Sandboxed Containers"
seoTitle: "Red Hat NVIDIA AI Factory: OpenShift Sandboxed Containers"
snippet: "Inside the Red Hat and NVIDIA joint session at Summit 2026 — OpenShift sandboxed containers, confidential compute, and AI Factory workload projection."
description: "Inside the Red Hat and NVIDIA joint session at Summit 2026 — OpenShift sandboxed containers, confidential compute threat models, and AI Factory workload projection."
image:
...
If you arrived here from a **`sandbox:/tmp` ChatGPT** search, note the terminology difference: ChatGPT's `sandbox:/tmp` path refers to a temporary execution sandbox, while this Red Hat Summit session used "sandbox" to mean OpenShift Sandboxed Containers with Kata runtime isolation for enterprise AI workloads.
