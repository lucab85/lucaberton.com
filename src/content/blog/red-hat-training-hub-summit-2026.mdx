...
description: "Red Hat Training Hub demo at Summit 2026 — unified API for SFT, LoRA, OSFT, GRPO fine-tuning. Live OSFT continual learning on Qwen 2.5 with MLFlow experiment."
