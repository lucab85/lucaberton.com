...
snippet: "Recap of RoachFest London 2026: CockroachDB's vision for AI agents, Form3's multi-cloud payments architecture, and Primer's zero-downtime migration."
description: "Recap of RoachFest London 2026 by Cockroach Labs — workshops on transactional vector search and RAG, Spencer Kimball's keynote on CockroachDB's agent-native future, Form3's multi-cloud payments architecture, Primer's zero-downtime migration to CockroachDB, and Major Tim Peake on operating without fear."
