---
draft: false
title: "Distributed vLLM on Run:ai: Deploying Mistral 119B with NCCL and RDMA"
...
description: "A real-world walkthrough of deploying Mistral-Small-4-119B across 2 GPUs using Run:ai distributed inference, vLLM 0.18.0, NCCL 2.27."
...
- [NVIDIA Run:ai Distributed Inference Platform Guide](/blog/nvidia-run-ai-distributed-inference-platform-2026/)
- [NVIDIA NIM Multi-Node Inference on Kubernetes](/blog/nvidia-nim-multi-node-deployment-helm-kubernetes-2026/)
- [NVIDIA NIM Model Profiles: Memory Classification and Selection](/blog/nvidia-nim-model-profiles-selection-guide-2026/)
