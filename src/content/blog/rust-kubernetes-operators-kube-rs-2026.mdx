...
- [Kubernetes Operators Best Practices](/blog/kubernetes-operator-patterns-2026/) — patterns regardless of language
- [Multi-Tenant GPUs on Bare Metal](/blog/kubecon-2026-multi-tenant-gpus-talk/) — our KubeCon talk on GPU scheduling
