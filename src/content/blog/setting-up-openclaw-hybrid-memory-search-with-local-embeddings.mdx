---
draft: false
title: "Setting Up OpenClaw Hybrid Memory Search with Local Embeddings"
seoTitle: "OpenClaw Hybrid Memory Search with Local Embeddings (2026)"
snippet: "Configure OpenClaw hybrid memory search with local sentence-transformer embeddings. Set up all-MiniLM-L6-v2, tune search weights, and benchmark retrieval."
description: "Configure OpenClaw hybrid memory search using local sentence-transformer embeddings. Set up all-MiniLM-L6-v2, tune vector and text search weights, and benchmark retrieval quality."
