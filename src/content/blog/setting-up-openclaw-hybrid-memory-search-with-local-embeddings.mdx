...
snippet: "Configure OpenClaw hybrid memory search using local sentence-transformer embeddings. Set up all-MiniLM-L6-v2, tune vector and text search weights, and."
