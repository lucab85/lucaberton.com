...
Many organizations run both: Slurm for training, [Kubernetes for inference and serving](/blog/nvidia-gpu-operator-kubernetes-ai-ml/). The [NVIDIA GPU Operator](/blog/nvidia-gpu-operator-mofed-driver-policy/) bridges the Kubernetes side.
