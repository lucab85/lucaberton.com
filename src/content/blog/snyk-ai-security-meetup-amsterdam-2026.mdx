...
I spoke at the **AI Security Night** hosted by the AI Security Engineers Community at **The Social Hub** in Amsterdam. I delivered the second talk: **"Securing Multi-Tenant AI Platforms: Practical Lessons from OpenShift AI, GPUs, and MLOps"**, while Brian Vermeer ([@brianvermeer.nl](https://brianvermeer.nl)) opened with the headline talk: **"Breaching LLM-Powered Applications — Overcoming Security and Privacy Challenges"**.
