...
tags: ["AI security", "Snyk", "meetup", "Amsterdam", "agentic AI", "human-in-the-loop", "LLM security", "multi-tenant", "OpenShift AI"]
category: "AI"
author: "Luca Berton"
draft: false
---
...
I spoke at the **[AI Security Night](https://www.meetup.com/aiseceng-netherlands/events/314414697/)** hosted by the AI Security Engineers Community at **The Social Hub** in Amsterdam. I delivered the second talk: **"Securing Multi-Tenant AI Platforms: Practical Lessons from OpenShift AI, GPUs, and MLOps"**, while Brian Vermeer ([@brianvermeer.nl](https://brianvermeer.nl)) opened with the headline talk: **"Breaching LLM-Powered Applications — Overcoming Security and Privacy Challenges"**.
...
In the second session, I shared practical lessons from building multi-tenant AI/ML environments on Kubernetes and [OpenShift AI](/blog/openshift-ai-upgrade-rhoai-3x-summit-2026/), focusing on GPU-backed workloads. The talk covered:
...
The core message: as AI moves from single-team experiments to shared enterprise platforms, **security becomes a platform engineering problem** — not just an application concern. The same [multi-tenant GPU patterns](/blog/gpus-take-flight-red-hat-summit-2026/) I presented at Red Hat Summit apply directly to securing AI workloads at scale.
...
A big thank you to **Gerald Crescione** and the whole Snyk team for hosting, and to Davide for organizing another packed AI Security Engineers event. The community is already planning the next meetup — [join here](https://www.meetup.com/aiseceng-netherlands/).
