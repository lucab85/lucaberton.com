...
description: "Configure SR-IOV Virtual Functions (VFs) on Kubernetes using the NicClusterPolicy for dedicated network interfaces to GPU pods with near-bare-metal performance."
publishDate: "2026-03-09"
lastModified: "2026-03-09"
image: { src: "/blog/thumbnails/sriov-nic-cluster-policy-kubernetes-vfs.jpg", alt: "SR-IOV NicClusterPolicy on Kubernetes: VF Config" }
