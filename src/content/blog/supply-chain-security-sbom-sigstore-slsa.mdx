...
A Software Bill of Materials lists every component in your software. The [EU Cyber Resilience Act](https://lucaberton.com/blog/eu-cra-sbom-requirements-compliance/) makes SBOMs mandatory for products sold in the EU.
