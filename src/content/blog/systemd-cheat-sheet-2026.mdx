...
snippet: "systemd cheat sheet for Linux service management. systemctl start/stop/enable, unit file creation, journalctl log queries, timers, and service troubleshooting."
