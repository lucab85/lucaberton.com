...
snippet: "Trivy cheat sheet. Image scanning, filesystem scan, IaC scan, SBOM generation, and CI/CD integration. Copy-paste ready commands for daily operations."
