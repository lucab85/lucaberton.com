---
draft: false
title: "Unsloth on NVIDIA DGX Spark: 2x Faster Fine-Tuning in Under an Hour"
snippet: "A step-by-step guide to running Unsloth on the NVIDIA DGX Spark for optimized LLM fine-tuning. From pulling the PyTorch container to running your first LoRA training job — complete with troubleshooting and next steps."
description: "A step-by-step guide to running Unsloth on the NVIDIA DGX Spark for optimized LLM fine-tuning. From pulling the PyTorch container to running your first LoRA training job — complete with troubleshooting and next steps."
