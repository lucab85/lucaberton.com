...
description: "A deep look at Zyphra's Zaya1-8B: CCA / CCGQA attention, co-trained Markovian RSA reasoning, MLP+PID router, AMD MI300X training, and what actually runs locally on Apple Silicon and ROCm today."
image:
